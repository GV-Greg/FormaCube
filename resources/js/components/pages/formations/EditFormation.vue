    ...
    <div>
        ...
        <v-stepper v-model="step">
            <v-stepper-header>
                ...
                <v-stepper-step step="3">Infos Pouvoir Subsidiant</v-stepper-step>
            </v-stepper-header>
            <v-stepper-items class="pb-1">
                ...
                <!-- Contenu partie 3 : Les infos pour le pouvoir subsidiant  -->
                <v-stepper-content step="3">
                    <div class="step-content mb-6">
                        <form>
                            <div class="row row-cols-2">
                                <div class="col">
                                    <v-checkbox v-model="formInfosPouvsub.adresse" label="ADRESSE" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.age" label="ÂGE" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.num_national" label="NUMÉRO NATIONAL" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.diplome" label="DIPLOME" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.source_info" label="SOURCE INFO" class="myLabel" color="success" hide-details></v-checkbox>
                                </div>
                                <div class="col">
                                    <v-checkbox v-model="formInfosPouvsub.date_naissance" label="DATE DE NAISSANCE" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.email" label="EMAIL" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.statut_legal" label="STATUT LÉGAL" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.duree_chomage" label="DURÉE DE CHÔMAGE" class="myLabel" color="success" hide-details></v-checkbox>
                                    <v-checkbox v-model="formInfosPouvsub.groupe_social" label="GROUPE SOCIAL" class="myLabel" color="success" hide-details></v-checkbox>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="text-right">
                        ...
                        <v-btn color="btn btn-success text-light" @click="editInfosPouvSub()">&Eacute;diter</v-btn>
                    </div>
                </v-stepper-content>
            </v-stepper-items>
        </v-stepper>
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                this.formFormation
                    ...
                    .then(response => {
                        if(this.formFormation.successful) {
                            ...
                            this.getFormInfosPouvSub(this.infospouvsub)
                            this.step = 3;
                        }
                    })
                    .catch(error => {
                        this.$Progress.fail();
                        console.log(error);
                        if (error.response.statut && error.response.status === 422) {
            ...
            getFormInfosPouvSub(infospouvsub) {
                this.formInfosPouvsub.reset();
                this.formInfosPouvsub.clear();
                this.formInfosPouvsub.fill(infospouvsub);
                this.formInfosPouvsub.pouvsub_id = this.formFormation.pouvsub_id
            },
            editInfosPouvSub() {
                this.$Progress.start();
                this.formInfosPouvsub
                    .put(`/api/pouvsub-infos/edit/${this.formInfosPouvsub.id}`)
                    .then(response => {
                    ...
                    .catch(error => {
                        ...
                        if (error.response && error.response.status === 422) {
                            ...
                            Snackbar.fire('Problème avec la modification des infos utiles pour le pouvoir subsidiant');
                        }
                    })
            }
        }
