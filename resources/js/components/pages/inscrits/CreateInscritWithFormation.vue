<template>
    <v-container fluid>
        ...
        <v-row align="center" class="mb-4">
            ...
            <v-col>
                <h1 class="text-h4">Nouvelle inscription <span class="text-subtitle-1 ml-2">pour la formation {{ formation.nom }} {{ formation.session }}</span></h1>
            </v-col>
        </v-row>
                    ...
                    <v-card-text>
                        ...
                        <v-row class="mt-4">
                            ...
                            <v-col class="text-right">
                                <v-btn color="success" @click="storeStagiaire()">Créer Stagiaire</v-btn>
                            </v-col>
                        </v-row>
                    </v-card-text>
                </v-card>
