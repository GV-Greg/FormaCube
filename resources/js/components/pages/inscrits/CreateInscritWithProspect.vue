<template>
    <div>
        <h1>
            ...
            Nouvelle inscription <span id="sous-titre">en tant que prospect</span>
        </h1>
            ...
            <v-stepper-items class="pb-1">
                            ...
                            <div class="row row-cols-2 mt-n3">
                                ...
                                <div class="col">
                                    ...
                                    <b-input-group class="mt-n2 mb-3">
                                        ...
                                        <b-form-input id="date_naissance" type="date" v-model="formInscrit.date_naissance"
                ...
                <v-stepper-content step="3">
                    ...
                    <div class="text-right">
                        ...
                        <v-btn class="btn-success text-light" @click="storeInscrit()">Finaliser</v-btn>
                    </div>
                </v-stepper-content>
            </v-stepper-items>
        </v-stepper>
