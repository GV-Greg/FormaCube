<template>
    <v-container fluid>
        ...
        <v-row align="center" class="mb-4">
            ...
            <v-col>
                <h1 class="text-h4">Nouvelle inscription <span class="text-subtitle-1 ml-2">en tant que prospect</span></h1>
            </v-col>
        </v-row>

        <!-- Stepper -->
        <v-stepper v-model="step" :items="['Généralités', 'Généralités (suite)', 'Choix Tags']" alt-labels>
            <!-- Step 1: Généralités -->
                ...
                <v-card flat>
                    <v-card-text>
                        ...
                        <v-row class="mt-4">
                            ...
                            <v-col class="text-right">
                                <v-btn color="success" @click="storeInscrit()">Créer Prospect</v-btn>
                            </v-col>
                        </v-row>
                    </v-card-text>
                </v-card>
...
export default {
    ...
    mounted() {
        console.log('CreateInscritWithProspect component mounted');
        this.getDatas();
    },
    computed: {
        validationMinNom() {
