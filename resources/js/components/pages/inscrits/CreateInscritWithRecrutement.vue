<template>
    <div class="container">
        <h1 class="d-flex align-content-center">
            ...
            <span class="d-flex align-baseline">Nouvelle inscription <span id="sous-titre" class="pl-2">pour le recrutement du {{ recrutement.date | newDate }}</span></span>
        </h1>
        <div class="row mt-2">
                ...
                <v-stepper-items class="pb-1">
                    ...
                    <v-stepper-content step="2">
                        ...
                        <div class="mt-3 d-flex justify-content-between">
                            ...
                            <span class="font-weight-light font-italic text-primary-dark mt-2"><small>Tous les champs avec * sont obligatoires</small></span>
                            <v-btn class="btn-primary" @click="storeCandidat()">Cr&eacute;er Candidat</v-btn>
                        </div>
                    </v-stepper-content>
                </v-stepper-items>
            </v-stepper>
