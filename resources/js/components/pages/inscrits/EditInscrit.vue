<template>
    <v-container fluid>
        ...
        <v-row align="center" class="mb-4">
            ...
            <v-col>
                <h1 class="text-h4">Modification d'une fiche</h1>
            </v-col>
        </v-row>
        ...
        <v-stepper v-model="step" :items="['Généralités', 'Généralités (suite)']" alt-labels>
            ...
            <template v-slot:item.2>
                <v-card flat>
                    <v-card-text>
                        <h6 class="font-weight-bold mb-4">Informations supplémentaires</h6>
                        ...
                        <v-row class="mt-4">
                            ...
                            <v-col class="text-right">
                                <v-btn color="success" @click="update()">Éditer</v-btn>
                            </v-col>
                        </v-row>
                    </v-card-text>
                </v-card>
