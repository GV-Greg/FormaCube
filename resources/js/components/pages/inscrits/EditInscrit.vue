    ...
    <div>
        ...
        <v-stepper v-model="step">
            <v-stepper-header>
                ...
                <v-stepper-step step="2">Infos Supp.</v-stepper-step>
            </v-stepper-header>
            <v-stepper-items class="pb-1">
                <!-- Contenu partie 1 : les généralités -->
                <v-stepper-content step="1" v-show="loading === true">
                ...
                <!-- Contenu partie 2 : Infos supplémentaires -->
                <v-stepper-content step="2">
                            ...
                            <div class="row">
                                <div class="col">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <b-form-textarea v-model="formInscrit.commentaire_inscrit" rows="1" class="form-control"
                            ...
                            <div class="row row-cols-3">
                                <div class="col-3">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <b-form-input v-if="formInscrit.date_naissance !== null" v-model.number="formInscrit.age" type="number"
                                        ...
                                        <b-input-group-append is-text v-show="pouvsubInfos.age === 1">
                                ...
                                <div class="col-4">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0" v-show="user.role === 'admin' || user.role === 'master'">
                                        ...
                                        <b-input-group-append is-text v-show="pouvsubInfos.num_national === 1">
                                ...
                                <div class="col-5">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <b-input-group-append is-text v-show="pouvsubInfos.statut_legal === 1">
                            ...
                            <div class="row row-cols-2" v-show="user.role === 'admin' || user.role === 'master'">
                                ...
                                <div class="col">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <b-input-group-append is-text v-show="pouvsubInfos.groupe_social === 1">
                            ...
                            <div class="row">
                                <div class="col">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <b-input-group-append is-text v-show="pouvsubInfos.diplome === 1">
                            ...
                            <div class="row">
                                <div class="col">
                                    <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <b-input-group-append is-text v-show="pouvsubInfos.source_info === 1">
                    ...
                    <div class="text-right">
                        ...
                        <v-btn class="btn-success text-light" @click="validationStepTwo()">&Eacute;diter</v-btn>
                    </div>
                </v-stepper-content>
            </v-stepper-items>
        </v-stepper>
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                axios.get(`/api/inscrits/show/${this.$route.params.id}`)
                    .then((response) => {
                        ...
                        if(response.data.formationInscrit != null) {
                            this.formationInscrit = response.data.formationInscrit;
                            this.stagiaire = true;
                        }
                    ...
                    .catch(error => {
                        ...
                        Snackbar.fire({
                            title: 'Problème avec la récupération des infos de la personne !',
                            timer: undefined,
                        })
                    })
            },
            ...
            getFormInscrit(inscrit) {
                this.formInscrit.reset();
                this.formInscrit.clear();
                this.formInscrit.fill(inscrit);
                this.formInscrit.newsletter = this.formInscrit.newsletter === 1;
            },
            verifInscrit() {
                this.champsObligatoires.genre = this.inscrit.genre === null;
                this.champsObligatoires.date_naissance = this.inscrit.date_naissance === null;
                this.champsObligatoires.ville_id = this.inscrit.ville_id === 2766;
                this.champsObligatoires.email = this.inscrit.email === null;
                this.champsObligatoires.tel = this.inscrit.tel === null;
                this.champsObligatoires.gsm = this.inscrit.gsm === null;
                if(this.inscrit.rue === null) {
                    this.formInscrit.rue = '';
                }
                if(this.inscrit.numero === null) {
                    this.formInscrit.numero = '';
                }
                if(this.inscrit.boite === null) {
                    this.formInscrit.boite = '';
                }
                if(this.inscrit.email === null) {
                    this.formInscrit.email = '';
                }
                if (this.inscrit.tel != null) {
                    this.tel_national = this.inscrit.tel.substring(0, 3);
                    let telTab = this.inscrit.tel.split('');
                    telTab.splice(0, 3);
                    this.formInscrit.tel = telTab.join('');
                }
                if (this.inscrit.gsm != null) {
                    this.gsm_national = this.inscrit.gsm.substring(0, 3);
                    let gsmTab = this.inscrit.gsm.split('');
                    gsmTab.splice(0, 3);
                    this.formInscrit.gsm = gsmTab.join('');
                }
                if(this.inscrit.commentaire_inscrit === null) {
                    this.formInscrit.commentaire_inscrit = '';
                }
                this.currentUser();
            },
            currentUser() {
            ...
            getAge() {
                if(this.formInscrit.date_naissance !== null && this.formInscrit.date_naissance !== '') {
                ...
                this.formInscrit
                    ...
                    .catch(error => {
                        ...
                        if (error.response.status && error.response.status === 422) {
                            Snackbar.fire('Personne déjà inscrite');
                        } else {
                            Snackbar.fire('Problème avec la modification de la personne !');
                        }
                    })
            },
        }
